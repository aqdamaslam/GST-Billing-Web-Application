...
$sql1 = "INSERT INTO jh_bill (invoice, username, placeofsupply, dateofinvoice, billpartyname, billpartyaddress, billpartygstin, coal, hsn, quantity, modeoftransport1, modeoftransport, shippartyname, shippartyaddress, shippartygstin, rate, amount, igst, cgst, sgst, cess, totalamount, tcs, grandtotal) 
VALUES 
...
$sql = "INSERT INTO jh_within_bill (invoice, placeofsupply, dateofinvoice, billpartyname, billpartyaddress, billpartygstin, coal, hsn, quantity, modeoftransport1, modeoftransport, shippartyname, shippartyaddress, shippartygstin, rate, amount, cgst, sgst, cess, totalamount, tcs, grandtotal) 
VALUES 
...
if($mysqli->query($sql1) === true && $mysqli->query($sql) === true){
	header("Location: jh_within.php"); /* Redirect browser */
} else{
