...
$sql= "SELECT * FROM jh_within_bill WHERE invoice LIKE '%".$search."%' LIMIT 1";
...
<table width="1000" height="80">
  ...
  <tr>
    <td align="left-side" height="80">NAME :- <?php echo $row['billpartyname']; ?>
	</td>
