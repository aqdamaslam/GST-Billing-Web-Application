...
$sql="SELECT * FROM up_bill ORDER BY id DESC LIMIT 1";
...
<div class="container">
  ...
  <ul class="nav nav-tabs nav-justified">
    <li class="active"><a href="up_login.php">Billing Outside UP</a></li>
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" method="post" action="up_search.php" target="_blank">
 
 <input style="border: none; border-color: black; background-color:white; color:white;" id="username" name="username" value='<?php echo $_SESSION['username']; ?>' readonly>

	<div class="col-sm-25" style="background-color:white;"><font size="10"><center><b>M/s HIRA COAL MINES PVT LTD</font></b></center></div>
	  
	<div class="col-sm-25" style="background-color:white;"><center><font size="5">C-C 6 G.T.B NAGAR KARELI,</font></center></div>
	  
	<div class="col-sm-25" style="background-color:white;"><center><font size="5">ALLAHABAD, U.P.</center></font></div></br></br></br>
		...
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				...
				<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="invoice" name="invoice" value="<?php while($jh_outside_bill=mysql_fetch_assoc($records)){ echo $jh_outside_bill['id']; } ?>" placeholder="Invoice Number" >
					</div>
			</div>
		</div>
		...
		<div class="col-sm-6" style="background-color:white;"><center><b>SHIP TO PARTY</b></center></br>
			<div class="row">
				...
				<div class="col-sm-6" style="background-color:white;">IGST : (5%) (Rs)</div>
					<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="igst" name="igst" placeholder="IGST : (5%)" readonly>
					</div>
				...
				<div class="col-sm-6" style="background-color:white;">Other Charges (Rs)</div>
					<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="othercharges" name="othercharges" placeholder="Total Amount">
					</div>
