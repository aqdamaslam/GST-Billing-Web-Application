...
<div class="container">
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="cust_reg" method="post" action="admin_jh_emp_outside_edit_print.php" >
		...
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				<div class="col-sm-6" style="background-color:white;">Date OF INVOICE & Supply</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="dateofinvoice" name="dateofinvoice" value="<?php echo $_POST['dateofinvoice']; ?>" placeholder="Date Of INVOICE" required   readonly>
					</div>		
			</div>
		</div>
	</div>
		...
		<div class="col-sm-6" style="background-color:white;"><center><b>Bill TO PARTY</b></center>
			<div class="row">
				<div class="col-sm-6" style="background-color:white;">Bill Party Name :</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="billpartyname" name="billpartyname" value = "<?php while($row=mysql_fetch_array($records)){ ?><?php echo $row['billpartyname'];?>"  readonly>
