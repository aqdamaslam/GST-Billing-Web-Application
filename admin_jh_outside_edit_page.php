...
$sql= "SELECT * FROM jh_bill WHERE invoice LIKE '%".$search."%' LIMIT 1";
...
<div class="container">
  ...
  <ul class="nav nav-tabs nav-justified">
    <li><a href="add_emp.php">Add Employee ID</a></li>
    <li><a href="add_cust.php">Add New Customer</a></li>
    <li class="active"><a href="update_entry.php">Update</a></li>
    <li><a href="data_collection.php">Data Collection</a></li>
  </ul>
</div>
</br></br></br>
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="cust_reg" method="post" action="admin_jh_outside_edit_pre.php" target="_blank">
		...
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				...
				<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="invoice" name="invoice" value= "<?php while($row=mysql_fetch_array($records)){ ?> <?php echo $row['invoice']; ?> ">
					</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				<div class="col-sm-6" style="background-color:white;">Date OF INVOICE & Supply</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="dateofinvoice" name="dateofinvoice" value="<?php echo $row['dateofinvoice']; ?>" placeholder="Date Of INVOICE" required>
					</div>		
			</div>
		</div>
	</div>
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				...
				<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="placeofsupply" name="placeofsupply" value="<?php echo $row['placeofsupply']; ?>" placeholder="Place Of Supply">
					</div>
			</div>
		</div>
</div>
		...
		<div class="col-sm-6" style="background-color:white;"><center><b>Bill TO PARTY</b></center>
			<div class="row">
				...
				<div class="col-sm-6" style="background-color:white;">Bill Party Address :</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="billpartyaddress" name="billpartyaddress"  value="<?php echo $row['billpartyaddress']; ?>" placeholder="Party Address">
					</div>
				<div class="col-sm-6" style="background-color:white;">Bill Party GSTIN Number :</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="billpartygstin" name="billpartygstin" placeholder="GSTIN No." value="<?php echo $row['billpartygstin']; ?>"  pattern="[A-Z0-9]+" title="Enter Valid GSTIN Number">
					</div>
		...
		<div class="col-sm-6" style="background-color:white;"><center><b>SHIP TO PARTY</b></center>
			<div class="row">
				...
				<div class="col-sm-6" style="background-color:white;">Ship Party Address :</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="shippartyaddress" name="shippartyaddress"  value="<?php echo $row['shippartyaddress']; ?>" placeholder="Party Address">
					</div>
				<div class="col-sm-6" style="background-color:white;">Party GSTIN Number :</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="shippartygstin" name="shippartygstin" placeholder="GSTIN No." value="<?php echo $row['shippartygstin']; ?>"  pattern="[A-Z0-9]+" title="Enter Valid GSTIN Number">
					</div>
				...
				<div class="col-sm-6" style="background-color:white;">Amount : (Rs)</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="amount" name="amount" value="<?php echo $row['amount']; ?>" placeholder="Amount : (Rs)">
					</div>
				<div class="col-sm-6" style="background-color:white;">IGST : (5%) (Rs)</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="igst" name="igst" value="<?php echo $row['igst']; ?>" placeholder="IGST : (5%)">
					</div>
				<div class="col-sm-6" style="background-color:white;">CESS 400/M.T (Rs)</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="cess" name="cess" value="<?php echo $row['cess']; ?>" placeholder="CESS 400/M.T">
					</div>
				<div class="col-sm-6" style="background-color:white;">Total Amount (Rs)</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="totalamount" name="totalamount" value="<?php echo $row['totalamount']; ?>" placeholder="Total Amount">
					</div>
				<div class="col-sm-6" style="background-color:white;">TCS 1% (Rs)</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="tcs" name="tcs" value="<?php echo $row['tcs']; ?>" placeholder="Total Amount">
					</div>
				<div class="col-sm-6" style="background-color:white;">Other Charges (Rs)</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="othercharges" name="othercharges" value="<?php echo $row['othercharges']; ?>" placeholder="Total Amount">
					</div>
				<div class="col-sm-6" style="background-color:white;">Grand Total (Rs)</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="grandtotal" name="grandtotal" value="<?php echo $row['grandtotal']; ?>" placeholder="Grand Total"> <?php } ?>
					</div>			
			</div>
		</div>
	</div>
...
<div class="container"><center>
  <button type="submit" class="btn btn-success" name="submit" id="submit">Next</button>
	...
	<div class="pull-center">
		<input style="border: none; border-color: transparent; background-color:white; color:black;" id="username" name="username" value='<?php echo $_SESSION['username']; ?>' readonly>
	</div>
</form>
</br>
</body>
