...
<h3 align="center">Jharkhand Detail</h3><br />
<form action="admin_jh_outside_searchbyinvoice.php" method="post" target="_blank">

<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				<div class="col-sm-6" style="background-color:white;">Jharkhand Outside Search By Bill Number</div>
...
<form action="admin_jh_within_searchbyinvoice.php" method="post" target="_blank">

<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				<div class="col-sm-6" style="background-color:white;">Jharkhand Within Search By Bill Number</div>
					<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="invoice" name="invoice" pattern="[0-9]+" placeholder="Enter Invoice Number">
					</div>
			</div>
...
<form action="admin_jh_searchbybillpartyname.php" method="post" target="_blank">
<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				<div class="col-sm-6" style="background-color:white;">Jharkhand Search By Bill Party Name</div>
					<div class="search-box" style="background-color:white;">
...
<form action="admin_jh_searchbydate.php" method="post" target="_blank">
...
<form action="admin_jh_emp_outside_edit.php" method="post" target="_blank">
...
<div class="col-sm-6" style="background-color:white;">
	...
	<div class="pull-center">
		<input style="border: none; border-color: transparent; background-color:white; color:white;" id="username" name="username" value='<?php echo $_SESSION['username']; ?>' readonly>
				...
				<div class="col-sm-6" style="background-color:white;">Outside Jharkhand Edit</div>
					<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="edit" name="edit" pattern="[0-9]+" placeholder="Enter Bill Party Name">
					</div>
			</div>
</div>
...
<form action="admin_jh_emp_within_edit.php" method="post" target="_blank">
...
<div class="col-sm-6" style="background-color:white;">
	...
	<div class="pull-center">
		<input style="border: none; border-color: transparent; background-color:white; color:white;" id="username" name="username" value='<?php echo $_SESSION['username']; ?>' readonly>
				...
				<div class="col-sm-6" style="background-color:white;">Within Jharkhand Edit</div>
					<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="edit" name="edit" pattern="[0-9]+" placeholder="Enter Bill Party Name">
					</div>
			</div>
...
<h3 align="center">UP Detail</h3><br />
<form action="admin_up_outside_searchbyinvoice.php" method="post" target="_blank">
...
<form action="admin_up_within_searchbyinvoice.php" method="post" target="_blank">
...
<form action="admin_up_searchbybillpartyname.php" method="post" target="_blank">
<div class="col-sm-6" style="background-color:white;">
			<div class="row">
...
<form action="admin_up_searchbydate.php" method="post" target="_blank">
...
<form action="admin_up_emp_outside_edit.php" method="post" target="_blank">
...
<form action="admin_up_emp_within_edit.php" method="post" target="_blank">
