...
<div class="container">
  ...
  <ul class="nav nav-tabs nav-justified">
    ...
    <li class="active"><a href="jh_old.php">Search Old Bill</a></li>
    <li><a href="jh_data_collection.php">Data Collection</a></li>
  </ul>
</div></br></br></br>
...
<body>
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="cust_reg" method="post" action="jh_emp_within_edit_pre.php" target="_blank">
		...
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				...
				<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="invoice" name="invoice" value="<?php echo $row['invoice']; ?>" readonly>
					</div>
			</div>
		</div>
		...
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				<div class="col-sm-6" style="background-color:white;">Date OF INVOICE & Supply</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="date" class="form-control" id="dateofinvoice" name="dateofinvoice" value="<?php echo $row['dateofinvoice']; ?>" placeholder="Date Of INVOICE" required>
					</div>		
			</div>
		</div>
	</div>
		...
		<div class="col-sm-6" style="background-color:white;"><center><b>Bill TO PARTY</b></center>
			<div class="row">
				...
				<div class="col-sm-6" style="background-color:white;">Bill Party Address</div>
					<div class="col-sm-4" style="background-color:white;">
						<input class="form-control" id="billpartyaddress" name="billpartyaddress" value="<?php echo $row['billpartyaddress']; ?>" >
					</div>
				<div class="col-sm-6" style="background-color:white;">GSTIN Number</div>
					<div class="col-sm-4" style="background-color:white;">
						<input class="form-control" id="billpartygstin" name="billpartygstin" value="<?php echo $row['billpartygstin']; ?>" >
					</div>
		...
		<div class="col-sm-6" style="background-color:white;"><center><b>SHIP TO PARTY</b></center>
			<div class="row">
				...
				<div class="col-sm-6" style="background-color:white;">Ship Party Address :</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" autocomplete="off" id="shippartyaddress" name="shippartyaddress"  value="<?php echo $row['billpartyaddress']; ?>" placeholder="Party Address">
					</div>
				<div class="col-sm-6" style="background-color:white;">Party GSTIN Number :</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control"  id="shippartygstin" name="shippartygstin" placeholder="GSTIN No." value="<?php echo $row['billpartygstin']; ?>"  pattern="[A-Z0-9]+" title="Enter Valid GSTIN Number">
						<div class="result1"></div>
					</div>
				...
				<div class="col-sm-6" style="background-color:white;">Grand Total (Rs)</div>
					<div class="col-sm-4" style="background-color:white;">
						<input type="text" class="form-control" id="grandtotal" name="grandtotal" value="<?php echo $row['grandtotal']; ?>" placeholder="Grand Total">
					</div>			
			</div>
		</div>
	</div>
