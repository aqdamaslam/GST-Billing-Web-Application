...
function myFunction() {
  ...
  alert("Bill Party GSTN: " + copyText.value);
}
...
function myFunction1() {
  ...
  /* Alert the copied text */
  alert("Ship Party GSTIN: " + copyText.value);
}
...
<div class="container">
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="cust_reg" method="post" action="jh_outside_pre.php">
	...
	<div class="col-sm-6" style="background-color:white;">
  	<div class="row">
		<div class="col-sm-6" style="background-color:white;">Date OF INVOICE & Supply</div>
			<div class="col-sm-6" style="background-color:white;">
	<input type="text" class="form-control" id="dateofinvoice" name="dateofinvoice" value="<?php echo $_POST['dateofinvoice']; ?>" placeholder="Date Of INVOICE" readonly>
		</div>		
			</div>
		</div>
	</div>
