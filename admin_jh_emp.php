...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="adminhome.php"><img src="img/logo.png" alt="Hira Coal Mines Pvt. Ltd.">
        </a>
    </div>
...
<div class="container">
  <h2 align="center">Jharkhand Employee ID Entry</h2>
  <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="loginsystem" method="post" action="admin_jh_emp_pre.php">
