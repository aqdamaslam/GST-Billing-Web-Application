...
$firstdate= mysql_real_escape_string($_REQUEST['firstdate']);
$seconddate = mysql_real_escape_string($_REQUEST['seconddate']);

 $query = "SELECT * FROM jh_bill WHERE dateofinvoice BETWEEN '".$firstdate."' AND  '".$seconddate."'";
 ...
 if(mysqli_num_rows($result) > 0)
 {
  ...
  header('Content-Disposition: attachment; filename=Between Dates.xls');
  echo $output;
 }
}
?>