...
<table width="1000" height="100" style="text-align: center;">
  ...
  <tr>
    <td align="center"><?php echo $_POST['invoice']; ?></td>
    <td align="center"><?php echo $_POST['dateofinvoice']; ?></td>
    <td align="center"><?php echo $_POST['placeofsupply']; ?></td>
  </tr>
</table>
<table width="1000" height="80">
  ...
  <tr>
    <td align="left-side" width="485" height="80"><b>NAME :-</b> <?php echo $_POST['billpartyname']; ?></td>
    <td align="left-side"><b>NAME :-</b> <?php echo $_POST['shippartyname']; ?></td>
  </tr>
  <tr>
    <td align="left-side" height="80"><b>ADDRESS :-</b> <?php echo $_POST['billpartyaddress']; ?>></td>
    <td align="left-side"><b>ADDRESS :-</b> <?php echo $_POST['shippartyaddress']; ?></td>
  </tr>
  <tr>
    <td align="left-side" height="80"><b>GSTIN No. :-</b> <?php echo $_POST['billpartygstin']; ?></td>
    <td align="left-side"><b>GSTIN No. :-</b> <?php echo $_POST['shippartygstin']; ?></td>
  </tr>
</table>
...
<table width="1000" height="180">
  <tr>
	...
	<p style="text-align: left;"><b>3. Interest rate of 18% p.a will be charge on late payment of more than 7 days.</b></b></u></font></p>
	<p style="text-align: left;"><b>4. Subject to Allahabad Jurisdiction.</b></b></u></font></p>
	</th>
  </tr>
</table>
<table width="1000" height="80">
...
<form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="jh_outside_bill" method="post" action="jh_emp_outside_update.php">
...
<div class="container"><center>
  <button class="btn btn-success" onclick="myFunction()">Print And Save</button>
  </center>
