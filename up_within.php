...
<div class="container">
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" method="post" action="up_within_search.php" target="_blank">
		...
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				...
				<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="invoice" name="invoice" value="<?php while($jh_bill=mysql_fetch_assoc($records)){ echo $jh_bill['id']; } ?>" placeholder="Invoice Number" >
					</div>
			</div>
		</div>
