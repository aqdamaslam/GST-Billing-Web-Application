...
$sql= "SELECT * FROM up_bill WHERE invoice LIKE '%".$search."%' LIMIT 1";
...
<div class="container">
  ...
  <ul class="nav nav-tabs nav-justified">
    ...
    <li class="active"><a href="admin_update_entry.php">Update</a></li>
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="cust_reg" method="post" action="admin_up_outside_edit_pre.php" target="_blank">
