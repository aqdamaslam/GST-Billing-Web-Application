...
<form action="jh_outside_searchbyinvoice.php" method="post" target="_blank">
...
<form action="jh_within_searchbyinvoice.php" method="post" target="_blank">
...
<form action="jh_searchbybillpartyname.php" method="post" target="_blank">
<div class="col-sm-6" style="background-color:white;">
			<div class="row">
...
<form action="jh_searchbydate.php" method="post" target="_blank">
...
<form action="jh_emp_outside_edit.php" method="post" target="_blank">
...
<form action="jh_emp_within_edit.php" method="post" target="_blank">
