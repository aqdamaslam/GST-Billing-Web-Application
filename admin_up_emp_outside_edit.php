...
$sql= "SELECT * FROM up_outside_bill WHERE invoice LIKE '%".$search."%' LIMIT 1";
...
<div class="container">
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="cust_reg" method="post" action="admin_up_emp_outside_edit_pre.php" target="_blank">
