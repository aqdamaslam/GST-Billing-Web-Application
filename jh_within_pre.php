...
<table width="1000" height="80" style="text-align: center;">
  ...
  <tr>
    <td><input style="border: none; border-color: transparent;" id="invoice" name="invoice" value="<?php while($jh_bill=mysql_fetch_assoc($records)){ echo $jh_bill['id']; } ?>" readonly></td>
...
<form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="jh_outside_bill" method="post" action="jh_within_submit.php">
