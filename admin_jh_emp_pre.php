...
<div class="container">
  <h2>Jharkhand Employee ID Entry</h2>
...
<form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="cust_reg" method="post" action="admin_jh_emp_add.php">
