...
$sql = "INSERT INTO jh_bill (invoice, username, placeofsupply, dateofinvoice, billpartyname, billpartyaddress, billpartygstin, coal, hsn, quantity, modeoftransport1, modeoftransport, shippartyname, shippartyaddress, shippartygstin, rate, amount, igst, cgst, sgst, cess, totalamount, tcs, othercharges, grandtotal) 
VALUES 
...
$sql1 = "INSERT INTO jh_outside_bill (invoice, placeofsupply, dateofinvoice, billpartyname, billpartyaddress, billpartygstin, coal, hsn, quantity, modeoftransport1, modeoftransport, shippartyname, shippartyaddress, shippartygstin, rate, amount, igst, cess, totalamount, tcs, othercharges, grandtotal) 
VALUES 
...
if($mysqli->query($sql) === true && $mysqli->query($sql1) === true){
	header("Location: jh_login.php"); /* Redirect browser */
} else{
