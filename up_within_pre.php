...
<table width="1000" height="80" style="text-align: center;">
  ...
  <tr>
    <td>GST/2017-18/ <input style="border: none; border-color: transparent;" id="invoice" name="invoice" value="<?php while($jh_bill=mysql_fetch_assoc($records)){ echo $jh_bill['id']; } ?>" readonly></td>
...
<table align="left" width="1000" height="100" style="text-align: center;">
  ...
  <tr>
    ...
    <td><?php echo $_POST['cgst']; ?></td>
  </tr>
  <tr>
    <td height="50">HSN CODE</td>
    <td>Rate(Per M.T)</td>
    <td>SGST (2.5%) In Rs</td>
    <td><?php echo $_POST['sgst']; ?></td>
  </tr>
  <tr>
...
<table width="1000" height="180">
  <tr>
    <th><p style="text-align: left;">1. E & OE</b></font></p>
...
<form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" id="jh_outside_bill" method="post" action="up_within_submit.php">
      ...
      <input type="hidden" name="cgst" value="<?php echo $_POST['cgst'] ?>">
      <input type="hidden" name="sgst" value="<?php echo $_POST['sgst'] ?>">
