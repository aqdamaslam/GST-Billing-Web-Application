...
<div class="container">
  ...
  <ul class="nav nav-tabs nav-justified">
    <li class="active"><a href="jh_login.php">Billing Outside Jharkhand</a></li>
 ...
 <form class="form-horizontal" role="form" name="myform" onsubmit="return validateform()" method="post" action="jh_search.php" target="_blank">
		...
		<div class="col-sm-6" style="background-color:white;">
			<div class="row">
				...
				<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="invoice" name="invoice" value="<?php while($jh_outside_bill=mysql_fetch_assoc($records)){ echo $jh_outside_bill['id']; } ?>" placeholder="Invoice Number" readonly>
					</div>
			</div>
		</div>
		...
		<div class="col-sm-6" style="background-color:white;"><center><b>Bill TO PARTY</b></center></br>
			<div class="row">
				...
				<div class="col-sm-6" style="background-color:white;">Quantity(In M.T)</div>
					<div class="search-box" style="background-color:white;">
						<input type="text" class="form-control" id="quantity" name="quantity" placeholder="Quantity(In M.T)">
					</div>
